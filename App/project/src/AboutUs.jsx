...
const AboutUs = () => {
  ...
  const faqs = [
    {
      question: "What is LawMate?",
      answer:
        "LawMate is India's advanced AI-powered legal assistant, designed to make legal knowledge accessible to everyone, free of cost. With cutting-edge AI technology, LawMate helps individuals understand complex legal matters effortlessly, ensuring that legal guidance is just a conversation away. LawMate offers multilingual support, making legal assistance available in multiple Indian languages to bridge the gap between legal knowledge and the people who need it most. Whether you seek insights into property disputes, criminal law, consumer rights, or any other legal domain, LawMate is here to guide you. Conceptualized and developed independently, LawMate is committed to providing accurate, AI-driven legal insights, empowering individuals with the knowledge to make informed decisions. Start your journey with LawMate today—explore legal information in your preferred language and take control of your rights with confidence!",
    },
    {
      question: "Do I need an account to use LawMate?",
      answer:
    ...
    {
      question: "Which languages does LawMate support?",
      answer:
    ...
    },
    {
      ...
      answer:
        "LawMate is designed to handle multiple queries seamlessly, and you can switch between various specialized chatbots as needed.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0d0d0d] to-[#121212] text-white">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1589829545856-d10d557cf95f?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8bGF3fGVufDB8fDB8fHww')",
        ...
        >
          ...
          <div className="inline-block mb-6">
            <div className="h-20 w-20 rounded-full bg-gradient-to-br from-purple-600 to-blue-500 flex items-center justify-center mx-auto">
              <span className="text-white font-bold text-3xl">LM</span>
            </div>
          </div>
          <br></br>
          <br></br>
      ...
      <div className="container max-w-6xl mx-auto px-6 py-24">
        ...
        <Fade triggerOnce direction="up">
          <div className="text-center mb-24">
            <h2 className="text-4xl font-bold mb-6">
              Transforming Legal Assistance
            </h2>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              LawMate leverages cutting-edge AI to make legal services simple,
              accessible, and efficient for everyone in India.
            </p>
          </div>
        </Fade>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-24">
          ...
          <Fade triggerOnce direction="left">
            <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-500 group">
              ...
              <h2 className="text-3xl font-semibold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-blue-500">
                Our Mission
              </h2>
              <ul className="space-y-4 text-gray-300">
                <li className="flex items-start">
                  ...
                  <span>
                    Leverage AI to simplify legal related queries for everyone.
                  </span>
                </li>
                <li className="flex items-start">
                  ...
                  <span>
                    Provide 24/7 support and instant access to essential
                    information.
                  </span>
                </li>
                <li className="flex items-start">
                  ...
                  <span>
                    Ensure inclusivity with services in multiple languages and
                    formats.
                  </span>
                </li>
              </ul>
          ...
          <Fade triggerOnce direction="right">
            <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-500 group">
              ...
              <h2 className="text-3xl font-semibold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-teal-400">
                Our Vision
              </h2>
              <ul className="space-y-4 text-gray-300">
                <li className="flex items-start">
                  ...
                  <span>
                    Enable every citizen to interact with Indian Judiciary as
                    easily as chatting with a friend.
                  </span>
                </li>
                <li className="flex items-start">
                  ...
                  <span>
                    Enhance transparency, efficiency, and trust in public
                    services with intuitive AI.
                  </span>
                </li>
                <li className="flex items-start">
                  ...
                  <span>
                    Evolve continuously to meet the changing needs of citizens
                    and governments.
                  </span>
                </li>
              </ul>
        ...
        <Fade triggerOnce>
          <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl p-8 mb-24 relative overflow-hidden">
            ...
            <h2 className="text-3xl font-semibold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-blue-500 relative z-10">
              Why LawMate is Better
            </h2>
            <p className="text-gray-300 mb-8 max-w-3xl relative z-10">
              We stand out by focusing exclusively on specialized legal
              services, backed by robust AI and a user-friendly design that
              makes complex legal information accessible to everyone.
            </p>
        ...
        <Fade triggerOnce>
          <div className="text-center backdrop-blur-md bg-gradient-to-r from-purple-900/30 to-blue-900/30 border border-white/10 rounded-2xl p-12 relative overflow-hidden">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto relative z-10">
              Join thousands of Indians who are simplifying their legal journey
              with LawMate's AI-powered assistance.
            </p>
          </div>
        </Fade>
      </div>
...
const FeatureCard = ({ icon, title, description, gradient }) => (
  <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 hover:bg-white/10 transition-all duration-300 group">
    <div
      className={`h-12 w-12 rounded-lg bg-gradient-to-br ${gradient} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}
    >
      {icon}
    </div>
