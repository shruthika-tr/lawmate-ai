  ...
  useFrame(({ mouse }) => {
    if (modelRef.current) {
      ...
      modelRef.current.rotation.y = Math.max(
        -Math.PI / 2,
        Math.min(Math.PI / 2, modelRef.current.rotation.y)
      );
      modelRef.current.rotation.x = Math.max(
        -Math.PI / 6,
        Math.min(Math.PI / 6, modelRef.current.rotation.x)
      );
    }
  });
  return (
      ...
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
        ...
        <div className="md:w-1/2 text-left">
          ...
          <p className="text-gray-300 mt-4 max-w-xl">
            AI-powered legal assistant that provides instant, accessible
            insights on Indian laws. Covering civil, criminal, family, and
            property law, it simplifies complex legal concepts for easy
            understanding. With a freemium model and continuous AI improvements,
            LawMate bridges the gap between citizens and legal information,
    ...
    <section className="bg-[#0d0d0d] text-white py-16 px-4">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="mx-auto w-full max-w-3xl h-64 md:h-96 bg-[#2a2a2a] rounded-lg flex items-center justify-center mb-10">
          <p className="text-gray-500 text-xl">Video or Image Placeholder</p>
        </div>
      ...
      <div className="bg-[#191919] mt-16 py-10 text-center px-4">
        ...
        <p className="text-gray-400 mb-6">
          Join thousands of users who are already benefiting from our legal
          assistance chatbots.
        </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-gray-100">
        <div>
          ...
          <p className="text-gray-200">
            Explore legal knowledge, simplify complex Indian laws, and access
            AI-powered legal assistance in your language!
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li className="flex items-center hover:text-white transition">
              ...
              <a
                href="mailto:support@lawmate.gov.in"
                className="hover:underline"
              >
                support@lawmate.gov.in
              </a>
            </li>
            <li className="flex items-center hover:text-white transition">
              <FiPhone size={18} className="text-white mr-2" />
              <span>1800-LAWMATE</span>
            </li>
          </ul>
        </div>
      </div>
      <div className="border-t border-white/30 mt-8 pt-8 text-center text-gray-200">
        <p>© 2025 LawMate. All rights reserved.</p>
        <p className="text-sm max-w-2xl mx-auto mt-2">
          LawMate is an AI-driven platform providing general legal information.
