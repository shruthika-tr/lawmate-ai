  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-md p-8 rounded-2xl backdrop-blur-lg bg-white/10 shadow-xl border border-white/20 z-10">
        ...
        <h2 className="text-3xl font-bold mb-2 text-center bg-gradient-to-r from-blue-300 via-purple-300 to-pink-300 text-transparent bg-clip-text">
          welcome back
        </h2>
        <p className="text-center mb-6 text-gray-300">
          access your gov services
        </p>
        ...
        {authMode === "password" ? (
          ...
          <form
            onSubmit={otp ? handleOtpVerification : handleOtpLogin}
            className="space-y-4"
          >
            <div>
