...
const ServicesPage = () => {
  ...
  const handleFindProfessionals = (service) => {
    const serviceParam =
      service.title === "Personal and Family Legal Assistance"
        ? "personal-and-family-legal-assistance"
        : "business-consumer-and-criminal-legal-assistance";
    navigate(`/legal_professionals?service=${serviceParam}`);
  };
        ...
        <Fade triggerOnce>
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-6">
              Explore Our Legal Chatbots
            </h2>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Our specialized AI chatbots are designed to provide instant legal
              guidance across a wide range of topics, making legal assistance
          ...
          {servicesData.map((service, index) => (
            ...
            >
              <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:bg-white/10 transition-all duration-500 group">
                <div className="p-8">
                  <div
                    className={`h-20 w-20 flex items-center justify-center text-4xl mb-6 rounded-2xl bg-gradient-to-br ${service.color} group-hover:scale-110 transition-all duration-500`}
                  >
                    {service.icon}
                  </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {service.features.map((feature, idx) => (
                        <div key={idx} className="flex items-center">
                          <span
                            className={`h-5 w-5 rounded-full bg-gradient-to-br ${service.color} flex items-center justify-center mr-2`}
                          >
                            <svg
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <button
                      onClick={() => handleFindProfessionals(service)}
                      className={`w-full py-3 rounded-lg font-medium border border-white/20 text-white hover:bg-white/10 transition-all duration-300`}
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
              <div className="text-center">
                ...
                <p className="text-gray-300">
                  Choose the legal service that matches your requirements from
              ...
              <div className="text-center">
                ...
                <p className="text-gray-300">
                  Interact with our specialized AI assistant in your preferred
                  language to get guidance.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-300">
                  Receive personalized legal guidance, document assistance, and
